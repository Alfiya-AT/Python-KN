...
# >>>>>>> 0e0f317508ae1d76f62f6a2f1cfaf1308feb5833
# # ---------------------12/6/26--------------------------
...
# longest word in str
# word=["cat","tiger","lion","elephant"]
# l=list(map(lambda x: len(x),word))
# idx=l.index(max(l))
# print(word[idx])
...
# 1. Build in Exceptions   2. User defined Exceptions


# 1.Build in Exceptions

# l1=[1,32,4543,32,234,34]
# try:
...
#  
#     print(l1[index])
#     # IndexError is an exception object 
# except IndexError as e:
#     print(e)


# **how many except block r needed for any no of exceptions => 1 
# l1=[1,2,3,4,5]
# try:
#     index=34.3
